...
$hasOldMessages = $room->messages->contains(function($message) {
return !$message->created_at->isToday();
});
@endphp

<div class="w-full overflow-hidden transition-all duration-150 bg-white user-chat dark:bg-zinc-800" style="height:100vh;">
    <div class="lg:flex">
                    ...
                    <div class="col-span-8 sm:col-span-4">
                        <div class="flex items-center">
                            ...
                            <div class="rtl:ml-3 ltr:mr-3">
                                @if($userTo->avatar)
                                <img src="{{asset('images/avatar-4.jpg')}}" class="rounded-full h-9 w-9" alt="">
                                @else
                                <div class="rounded-full w-10 h-10 flex items-center justify-center group-data-[theme-color=violet]:bg-violet-500/20 group-data-[theme-color=green]:bg-green-500/20 group-data-[theme-color=red]:bg-red-500/20">
                                    <span class="font-medium leading-9 group-data-[theme-color=violet]:text-violet-500 group-data-[theme-color=green]:text-green-500 group-data-[theme-color=red]:text-red-500">
                                        {{str_split($room->users()->where('id', '!=', auth()->user()->id)->first()->name)[0]}}
                                    </span>
                                </div>
                                @endif
                            </div>
                            <div class="flex-grow overflow-hidden">
                                <h5 class="mb-0 truncate text-16 ltr:block rtl:hidden"><a href="#" class="text-gray-800 dark:text-gray-50">{{$userTo->name}}</a> <i class="text-green-500 ltr:ml-1 rtl:mr-1 ri-record-circle-fill text-10 "></i></h5>
                                <h5 class="mb-0 truncate text-16 rtl:block ltr:hidden">
                                    ...
                                    <a href="#" class="text-gray-800 dark:text-gray-50"></a>
                                </h5>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="p-4">
                                                    <div class="p-6">
                                                        <div class="p-4 text-center">
                                                            <div class="mb-6">
                                                                <img src="{{asset('images/avatar-4.jpg')}}" alt="" class="w-24 h-24 mx-auto rounded-full">
                                                            </div>
            ...
            <div class="h-[80vh] p-4 lg:p-6" data-simplebar>
                <ul class="mb-0">
                    <div id="chat-body">
                        ...
                        @if($hasOldMessages && $message->created_at->isToday() && !$todayFlag)
                        ...
                        <li class="clear-both py-4">
                                ...
                                <div>
                                    <div class="flex gap-2 mb-2">
                                        ...
                                        <div class="relative px-5 py-3 text-white rounded-lg ltr:rounded-bl-none rtl:rounded-br-none group-data-[theme-color=violet]:bg-violet-500 group-data-[theme-color=green]:bg-green-500 group-data-[theme-color=red]:bg-red-500">
                                            <p class="mb-0" id="chat-message-{{$message->id}}">
                                                {{$message->text}}
                                            </p>
                                            <p class="mt-1 mb-0 text-xs text-right text-white/50"><i class="align-middle ri-time-line"></i> <span class="align-middle">{{$message->created_at->format('H:i')}}</span></p>
                                            <!-- The chevron on the edge of the bubble -->
                                    ...
                                    <div class="font-medium text-gray-700 text-14 dark:text-gray-300">{{$message->sender->name}}</div>
                                </div>
                            </div>
                            @else
                            <!-- Right positiion -->
                            <div class="relative inline-flex items-end mb-6 text-right ltr:rtl:float-left ltr:float-right rtl:float-left">
                                <div class="order-3 mr-0 ltr:ml-4 rtl:mr-4">
                                    ...
                                    <div class="rounded-full w-10 h-10 flex items-center justify-center group-data-[theme-color=violet]:bg-violet-500/20 group-data-[theme-color=green]:bg-green-500/20 group-data-[theme-color=red]:bg-red-500/20">
                                        <span class="font-medium leading-9 group-data-[theme-color=violet]:text-violet-500 group-data-[theme-color=green]:text-green-500 group-data-[theme-color=red]:text-red-500">
                                            {{str_split($message->sender->name)[0]}}
                                        </span>
                                    </div>
                                    @endif
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="font-medium text-gray-700 rtl:text-left text-14 dark:text-gray-300">{{$message->sender->name}}</div>
                                </div>
                            </div>
                            @endif
                        </li>
                    ...
                    {{--
                            <li class="clear-both py-4">
                                <div class="flex items-end gap-3">
                                    <div>
                                        <img src="{{asset('images/avatar-4.jpg')}}" alt="" class="rounded-full h-9 w-9">
            </div>
        ...
        <li class="clear-both py-4">
            <div class="relative inline-flex items-end mb-6 text-right ltr:rtl:float-left ltr:float-right rtl:float-left">
                <div class="order-3 mr-0 ltr:ml-4 rtl:mr-4">
                    <img src="{{asset('images/avatar-1.jpg')}}" alt="" class="rounded-full h-9 w-9">
                </div>
                        ...
                        <div class="relative px-5 py-3 text-white rounded-lg ltr:rounded-bl-none rtl:rounded-br-none group-data-[theme-color=violet]:bg-violet-500 group-data-[theme-color=green]:bg-green-500 group-data-[theme-color=red]:bg-red-500">
                            ...
                            <ul class="relative mb-0">
                                <li class="relative inline-block mr-2">
                                    <div>
                                        <a class="inline-block m-1 popup-img" href="{{asset('images/small/img-1.jpg')}}" title="Project 1">
                                            <img src="{{asset('images/img-1.jpg')}}" alt="" class="border rounded h-28">
                                        </a>
                                    </div>
                                    <div class="absolute right-[10px] left-auto bottom-[10px]">
                                        <ul>
                                            <li class="inline-block p-2">
                                                <a download="img-1.jpg" href="{{asset('images/small/img-1.jpg')}}" class="font-medium">
                                ...
                                <li class="relative inline-block mr-2">
                                    <div>
                                        <a class="inline-block m-1 popup-img" href="{{asset('images/small/img-2.jpg')}}" title="Project 2">
                                            <img src="{{asset('images/img-2.jpg')}}" alt="" class="border rounded h-28">
                                        </a>
                                    </div>
                                    <div class="absolute right-[10px] left-auto bottom-[10px]">
                                        <ul class="mb-0 list-inline">
                                            <li class="inline-block p-2">
                                                <a download="img-2.jpg" href="{{asset('images/small/img-2.jpg')}}" class="font-medium">
                                                    <i class="text-lg ri-download-2-line"></i>
                                                </a>
                                            </li>
                                            <li class="relative self-start inline-block p-2 dropdown">
                                ...
                                <div class="flex flex-wrap items-center gap-2 attached-file">
                                    ...
                                    <div class="rtl:mr-4 ltr:ml-4">
                                        <div class="flex items-start gap-2">
                                            <div>
                                                <a download="admin_v1.0.zip" href="asset/images/small/admin_v1.0.zip" class="font-medium ">
    ...
    <div class="z-40 w-full p-2 mb-0 bg-white border-t lg:mb-1 border-gray-50 dark:bg-zinc-800 dark:border-zinc-700">
        <form id="messageForm">
            @csrf
            ...
            <div class="flex gap-2">
                ...
                <div class="flex-grow">
                    <input type="text" name="text" id="message" class="w-full border-transparent rounded bg-gray-50 placeholder:text-14 text-14 dark:bg-zinc-700 dark:placeholder:text-gray-300 dark:text-gray-300" placeholder="Enter Message...">
                </div>
                <div>
                    <div>
                        <ul class="mb-0">
...
<div class="user-profile-sidebar h-[100vh] bg-white shadow overflow-y-hidden mb-[85px] lg:mb-0 group-data-[theme-color=violet]:dark:bg-zinc-800 border-l-4 border-gray-50 dark:border-zinc-600 group-data-[theme-color=green]:dark:bg-zinc-700 group-data-[theme-color=red]:dark:bg-zinc-700 absolute xl:relative top-0 bottom-0" style="display: none;">
    ...
    <div class="p-6 text-center border-b border-gray-100 dark:border-zinc-600 flex flex-col items-center">
        <div class="mb-4">
            @if($userTo->avatar)
            <img src="{{asset('images/avatar-4.jpg')}}" class="rounded-full h-9 w-9 mx-auto" alt="">
            @else
            <div class="rounded-full w-14 h-14 flex items-center justify-center mx-auto group-data-[theme-color=violet]:bg-violet-500/20 group-data-[theme-color=green]:bg-green-500/20 group-data-[theme-color=red]:bg-red-500/20">
                <span class="font-medium leading-9 group-data-[theme-color=violet]:text-violet-500 group-data-[theme-color=green]:text-green-500 group-data-[theme-color=red]:text-red-500">
                    {{str_split($room->users()->where('id', '!=', auth()->user()->id)->first()->name)[0]}}
                </span>
            </div>
        ...
        <h5 class="mb-1 text-16 dark:text-gray-50">{{$userTo->name}}</h5>
        <h5 class="mb-0 truncate text-14 ltr:block rtl:hidden">
            <a href="#" class="text-gray-500 dark:text-gray-50">
                <i class="text-green-500 ltr:ml-1 rtl:mr-1 ri-record-circle-fill text-10"></i> Active
            </a>
        </h5>
        <h5 class="mb-0 truncate text-14 ltr:hidden rtl:block">
            <a href="#" class="text-gray-500 dark:text-gray-50">
                Active <i class="text-green-500 ltr:ml-1 rtl:mr-1 ri-record-circle-fill text-10"></i>
            </a>
        </h5>
    </div>
                ...
                <h2>
                    <button type="button" class="flex items-center justify-between w-full px-3 py-2 font-medium text-left border border-gray-100 rounded-t accordion-header group active dark:border-b-zinc-600 dark:bg-zinc-600 dark:border-zinc-600">
                        ...
                        <span class="m-0 text-[14px] dark:text-gray-50 font-semibold ltr:hidden rtl:block">
                            About <i class="mr-2 align-middle ri-user-2-line d-inline-block"></i>
                        </span>
                        <i class="ri-arrow-down-s-line text-lg group-[.active]:rotate-180 dark:text-gray-50"></i>
                    </button>
                </h2>
                ...
                <div class="block bg-white border border-t-0 border-gray-100 accordion-body dark:bg-transparent dark:border-zinc-600">
                    <div class="p-5">
                        <div>
                            ...
                            <h5 class="text-sm dark:text-gray-50">{{$userTo->name}}</h5>
                        </div>
                        <div class="mt-5">
                            <p class="mb-1 text-gray-500 dark:text-gray-300">Email</p>
                            <h5 class="text-sm dark:text-gray-50">{{$userTo->email}}</h5>
                        </div>
                        <div class="mt-5">
                            <p class="mb-1 text-gray-500 dark:text-gray-300">Time</p>
                            <h5 class="text-sm dark:text-gray-50">{{Carbon\Carbon::now()->format('H:i')}}</h5>
                        </div>
                        @if($userTo->location)
                        <div class="mt-5">
...
<script type="module">
    ...
    document.getElementById('messageForm').addEventListener('submit', submit);
    ...
    window.Echo.private('chat.' + chatRoomId)
        .listen('.sent', e => {
            ...
            const isOutgoing = (e.sender.id == authUser);

            let avatarHtml = '';
            if (e.sender.avatar) {
                avatarHtml = `<img src="${e.sender.avatar}" class="rounded-full h-9 w-9" alt="Avatar">`;
            } else {
                const firstLetter = e.sender.name ? e.sender.name.charAt(0).toUpperCase() : '';
                avatarHtml = `
                    <div class="rounded-full w-10 h-10 flex items-center justify-center group-data-[theme-color=violet]:bg-violet-500/20 group-data-[theme-color=green]:bg-green-500/20 group-data-[theme-color=red]:bg-red-500/20">
                        <span class="font-medium leading-9 group-data-[theme-color=violet]:text-violet-500 group-data-[theme-color=green]:text-green-500 group-data-[theme-color=red]:text-red-500">
                            ${firstLetter}
            ...
            if (!isOutgoing) {
                ...
                <div>
                    <div class="flex gap-2 mb-2">
                        <div class="relative px-5 py-3 text-white rounded-lg ltr:rounded-bl-none rtl:rounded-br-none
                                    group-data-[theme-color=violet]:bg-violet-500
                            ...
                            <p class="mt-1 mb-0 text-xs text-right text-white/50">
                                ...
                                <span class="align-middle">${new Intl.DateTimeFormat("bg-BG", {hour: "numeric", minute: "numeric"}).format(e.created_at)}</span>
                            </p>
                            <div class="before:content-[''] before:absolute before:border-[5px] before:border-transparent
                                        group-data-[theme-color=violet]:ltr:before:border-l-violet-500
                                        group-data-[theme-color=violet]:ltr:before:border-t-violet-500
                                        group-data-[theme-color=green]:ltr:before:border-l-green-500
                                        group-data-[theme-color=green]:ltr:before;border-t-green-500
                                        group-data-[theme-color=red]:ltr:before:border-l-red-500
                                        group-data-[theme-color=red]:ltr:before:border-t-red-500
                                        group-data-[theme-color=violet]:rtl:before:border-r-violet-500
                                        group-data-[theme-color=violet]:rtl:before:border-t-violet-500
                                        group-data-[theme-color=green]:rtl:before:border-r-green-500
                                        group-data-[theme-color=green]:rtl:before:border-t-green-500
                                        group-data-[theme-color=red]:rtl:before:border-r-red-500
                                        group-data-[theme-color=red]:rtl:before:border-t-red-500
                                        ltr:before:left-0 rtl:before:right-0 before:-bottom-2"></div>
                        </div>
                        <div class="relative self-start dropdown">
                            <a class="p-0 text-gray-400 border-0 btn dropdown-toggle dark:text-gray-100" href="#" role="button" data-bs-toggle="dropdown">
                                <i class="ri-more-2-fill"></i>
                            </a>
                            <div class="absolute z-50 hidden w-40 py-2 my-6 text-left list-none bg-white border-none rounded shadow-lg ltr:left-auto ltr:right-0 xl:ltr:left-0 xl:ltr:right-auto rtl:left-0 rtl:right-auto xl:rtl:right-0 xl:rtl:left-auto dropdown-menu bg-clip-padding dark:bg-zinc-700 dark:border-gray-600/50">
                                <a class="block w-full px-4 py-2 text-sm font-normal text-gray-700 bg-transparent dropdown-item whitespace-nowrap hover:bg-gray-100/50 dark:text-gray-100 dark:hover:bg-zinc-600 ltr:text-left rtl:text-right" href="#">Copy <i class="text-gray-500 rtl:float-left ltr:float-right dark:text-gray-200 ri-file-copy-line"></i></a>
                                <a class="block w-full px-4 py-2 text-sm font-normal text-gray-700 bg-transparent dropdown-item whitespace-nowrap hover:bg-gray-100/50 dark:text-gray-100 dark:hover:bg-zinc-600 ltr:text-left rtl:text-right" href="#">Save <i class="text-gray-500 rtl:float-left ltr:float-right dark:text-gray-200 ri-save-line"></i></a>
                                <a class="block w-full px-4 py-2 text-sm font-normal text-gray-700 bg-transparent dropdown-item whitespace-nowrap hover:bg-gray-100/50 dark:text-gray-100 dark:hover:bg-zinc-600 ltr:text-left rtl:text-right" href="#">Forward <i class="text-gray-500 rtl:float-left ltr:float-right dark:text-gray-200 ri-chat-forward-line"></i></a>
                                <a class="block w-full px-4 py-2 text-sm font-normal text-gray-700 bg-transparent dropdown-item whitespace-nowrap hover:bg-gray-100/50 dark:text-gray-100 dark:hover:bg-zinc-600 ltr:text-left rtl:text-right" href="#">Delete <i class="text-gray-500 rtl:float-left ltr:float-right dark:text-gray-200 ri-delete-bin-line"></i></a>
                    ...
                    <div class="font-medium text-gray-700 text-14 dark:text-gray-300">${e.sender.name}</div>
                </div>
            </div>
                    </li>
        `;
                                ...
                                <div>
                                    <div class="flex gap-2 mb-2 ltr:justify-end rtl:justify-start">
                                        ...
                                        <div class="relative order-2 px-5 py-3 text-gray-700 rounded-lg ltr:rounded-br-none rtl:rounded-bl-none bg-gray-50 dark:bg-zinc-700 dark:text-gray-50">
                                            ...
                                            <p class="mt-1 mb-0 text-xs text-left text-gray-500 dark:text-gray-300"><i class="align-middle ri-time-line"></i> <span class="align-middle">${new Intl.DateTimeFormat("bg-BG", {hour: "numeric", minute: "numeric"}).format(e.created_at)}</span></p>
                                            <!-- The chevron on the edge of the bubble -->
                                            <div class="before:content-[''] before:absolute before:border-[5px] before:border-transparent ltr:before:border-r-gray-50 ltr:before:border-t-gray-50 rtl:before:border-l-gray-50 rtl:before:border-t-gray-50 ltr:before:right-0 rtl:before:left-0 before:-bottom-2 ltr:dark:before:border-t-zinc-700 ltr:dark:before:border-r-zinc-700 rtl:dark:before:border-t-zinc-700 rtl:dark:before:border-l-zinc-700"></div>
                                        </div>
                                    ...
                                    <div class="font-medium text-gray-700 rtl:text-left text-14 dark:text-gray-300">${e.sender.name}</div>
                                </div>
                            </div>
                            </li>
                `;
